...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2025 at 08:17 AM
...
--
-- Database: `photographyreservationsystem`
--
...
--
ALTER TABLE `schedule`
  ADD CONSTRAINT `schedule_ibfk_1` FOREIGN KEY (`service_id`) REFERENCES `services` (`service_id`);
COMMIT;
